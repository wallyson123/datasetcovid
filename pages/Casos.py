...
# Agrupar por estado, mês e contar o número de casos
monthly_incidence = df.groupby(['state', 'Month']).size().reset_index(name='Cases')
...
fig = px.choropleth(total_cases_by_state,
                    locations='state',
                    locationmode='Brazil',  # Use 'Brazil' for Brazil maps
